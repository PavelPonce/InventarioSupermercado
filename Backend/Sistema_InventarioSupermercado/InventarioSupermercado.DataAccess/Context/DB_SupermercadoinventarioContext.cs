...
{
    public partial class DB_SupermercadoinventarioContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbClientes>(entity =>
            {
                ...
                entity.Property(e => e.Clien_Correo).IsRequired();
                ...
                entity.Property(e => e.Clien_Telefono)
                    .IsRequired()
                    .HasMaxLength(20);
            ...
            {
                entity.HasKey(e => e.Comde_Id)
                    .HasName("PK_tbComprasDetalle_Comde_Id");

                entity.ToTable("tbComprasDetalle", "Comp");

                entity.Property(e => e.Comde_Estado).HasDefaultValueSql("((1))");

                entity.Property(e => e.Comde_FechaCreacion).HasColumnType("datetime");

                entity.Property(e => e.Comde_FechaModificacion).HasColumnType("datetime");

                entity.HasOne(d => d.Comde_UsuarioCreacionNavigation)
                    .WithMany(p => p.tbComprasDetalleComde_UsuarioCreacionNavigation)
                    .HasForeignKey(d => d.Comde_UsuarioCreacion)
                    .OnDelete(DeleteBehavior.ClientSetNull);

                entity.HasOne(d => d.Comde_UsuarioModificacionNavigation)
                    .WithMany(p => p.tbComprasDetalleComde_UsuarioModificacionNavigation)
                    .HasForeignKey(d => d.Comde_UsuarioModificacion);

                entity.HasOne(d => d.Comen)
                    .WithMany(p => p.tbComprasDetalle)
                    .HasForeignKey(d => d.Comen_Id)
                    .OnDelete(DeleteBehavior.ClientSetNull);
                ...
                entity.HasOne(d => d.Produ)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tbComprasDetalle_tbProductos_ProdU_Id");
            ...
            {
                entity.HasKey(e => e.Comen_Id)
                    .HasName("PK_tbComprasEncabezado_Comen_Id");

                entity.ToTable("tbComprasEncabezado", "Comp");

                entity.Property(e => e.Comen_Estado).HasDefaultValueSql("((1))");

                entity.Property(e => e.Comen_FechaCreacion).HasColumnType("datetime");

                entity.Property(e => e.Comen_FechaIngreso).HasColumnType("date");

                entity.Property(e => e.Comen_FechaModificacion).HasColumnType("datetime");

                entity.HasOne(d => d.Comen_UsuarioCreacionNavigation)
                    .WithMany(p => p.tbComprasEncabezadoComen_UsuarioCreacionNavigation)
                    .HasForeignKey(d => d.Comen_UsuarioCreacion)
                    .OnDelete(DeleteBehavior.ClientSetNull);

                entity.HasOne(d => d.Comen_UsuarioModificacionNavigation)
                    .WithMany(p => p.tbComprasEncabezadoComen_UsuarioModificacionNavigation)
                    .HasForeignKey(d => d.Comen_UsuarioModificacion);
            ...
            modelBuilder.Entity<tbUnidades>(entity =>
            {
                ...
                entity.ToTable("tbUnidades", "Gral");
            ...
            modelBuilder.Entity<tbVentasDetalle>(entity =>
            {
                ...
                entity.HasOne(d => d.Produ)
                    ...
                    .HasForeignKey(d => d.Produ_Id)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tbVentasDetalle_tbProductos_ProdU_Id");
            ...
            modelBuilder.Entity<tbVentasEncabezado>(entity =>
            {
                ...
                entity.Property(e => e.Venen_FechaPedido).HasColumnType("date");
